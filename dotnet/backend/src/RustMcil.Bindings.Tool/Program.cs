...
Console.Error.WriteLine("       RustMcil.Bindings.Tool manifest --out <path>");
Console.Error.WriteLine("       RustMcil.Bindings.Tool manifest-json --out <path>");
Console.Error.WriteLine("       RustMcil.Bindings.Tool pack --out <directory>");
Console.Error.WriteLine("       RustMcil.Bindings.Tool validate --type <assembly-qualified-type>");
return 2;
