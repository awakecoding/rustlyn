...
{
    /// <summary>
    /// Scans a type for public static methods and properties that match supported binding signatures.
    ...
    public static IReadOnlyList<ManagedApiRequirement> ScanType(Type type)
    {
        ...
        // Scan public static properties with getters
    ...
    /// Supported: string, int, long, bool, void, string[], enums with int backing.
    /// </summary>
