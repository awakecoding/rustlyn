...
Console.Error.WriteLine("   or: RustMcil.Tool diagnose [--llvm-root <path>]");
return 1;
...
static int RunDiagnose(string[] args)
{
    ...
    else
    {
        ...
        Console.WriteLine("  Set RUSTMCIL_LLVM_ROOT or use --llvm-root to point at an LLVM toolchain.");
        allGood = false;
    }
