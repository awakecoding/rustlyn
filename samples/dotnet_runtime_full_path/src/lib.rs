...
#[unsafe(no_mangle)]
pub extern "C" fn dotnet_runtime_full_path_score() -> i32 {
    ...
    let directory_len = unsafe {
        rust_mcil_dotnet_path_get_directory_name_utf8_len(full_path.as_ptr(), full_written as i64)
    };
    ...
    full_written * 10000 + relative_written * 1000 + transformed_written * 100 + contains * 10 + index
}