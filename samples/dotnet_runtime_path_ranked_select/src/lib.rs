...
#[unsafe(no_mangle)]
pub extern "C" fn dotnet_runtime_path_ranked_select_score() -> i32 {
    ...
    let mut best_directory_rank = i32::MIN;
    ...
    while directory_index < 3 {
        ...
        if candidate_directory_rank > best_directory_rank {
            best_directory_rank = candidate_directory_rank;
    ...
    let mut best_file_rank = i32::MIN;
    ...
    while file_index < 3 {
        ...
        if candidate_file_rank > best_file_rank {
            best_file_rank = candidate_file_rank;
