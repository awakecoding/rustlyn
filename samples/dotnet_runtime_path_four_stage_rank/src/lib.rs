...
#[unsafe(no_mangle)]
pub extern "C" fn dotnet_runtime_path_four_stage_rank_score() -> i32 {
    ...
    let final_transformed_len = unsafe {
        rust_mcil_dotnet_string_replace_utf8_len(
            selected_leaf_transform_ptr,
            selected_leaf_transform_written as i64,
            final_old.as_ptr(),
    ...
    let final_index_digit = final_index.rem_euclid(10);
