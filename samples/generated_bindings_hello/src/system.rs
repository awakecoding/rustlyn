...
unsafe extern "C" {
    fn rust_mcil_bindgen_system_console_write_line_utf8(value_ptr: *const u8, value_length: i64) -> i32;
    fn rust_mcil_bindgen_system_console_write_line_string(string_handle: i32) -> i32;
    ...
    fn rust_mcil_bindgen_system_io_path_change_extension_string_string(
        path_handle: i32,
        extension_handle: i32,
        exception_out: *mut i32,
    ) -> i32;
    fn rust_mcil_bindgen_system_io_path_combine_string_string(
        path1_handle: i32,
        path2_handle: i32,
        exception_out: *mut i32,
    ) -> i32;
    fn rust_mcil_bindgen_system_io_path_ends_in_directory_separator_string(
        path_handle: i32,
        exception_out: *mut i32,
    ) -> i32;
    ...
    fn rust_mcil_bindgen_system_io_path_get_file_name_without_extension_string(
        path_handle: i32,
        exception_out: *mut i32,
    ) -> i32;
    ...
    fn rust_mcil_bindgen_system_io_path_get_relative_path_string_string(
    ...
    fn rust_mcil_bindgen_system_math_abs_f64(value: f64, exception_out: *mut i32) -> f64;
    fn rust_mcil_bindgen_system_math_sqrt_f64(value: f64, exception_out: *mut i32) -> f64;
    fn rust_mcil_bindgen_system_mathf_abs_f32(value: f32, exception_out: *mut i32) -> f32;
    fn rust_mcil_bindgen_system_mathf_cos_f32(value: f32, exception_out: *mut i32) -> f32;
    fn rust_mcil_bindgen_system_mathf_max_f32_f32(x: f32, y: f32, exception_out: *mut i32) -> f32;
    fn rust_mcil_bindgen_system_mathf_min_f32_f32(x: f32, y: f32, exception_out: *mut i32) -> f32;
    fn rust_mcil_bindgen_system_mathf_sin_f32(value: f32, exception_out: *mut i32) -> f32;
    fn rust_mcil_bindgen_system_mathf_sqrt_f32(value: f32, exception_out: *mut i32) -> f32;
    fn rust_mcil_bindgen_system_string_from_utf8(value_ptr: *const u8, value_length: i64, exception_out: *mut i32) -> i32;
    fn rust_mcil_bindgen_system_string_len(string_handle: i32, exception_out: *mut i32) -> i32;
    fn rust_mcil_bindgen_system_string_utf8_len(string_handle: i32, exception_out: *mut i32) -> i32;
    ...
    fn rust_mcil_bindgen_system_string_index_of_string(
        string_handle: i32,
        value_handle: i32,
        comparison: i32,
        exception_out: *mut i32,
    ) -> i32;
    fn rust_mcil_bindgen_system_string_starts_with_string(
        string_handle: i32,
        value_handle: i32,
        comparison: i32,
        exception_out: *mut i32,
    ) -> i32;
    fn rust_mcil_bindgen_system_string_ends_with_string(
        string_handle: i32,
        value_handle: i32,
        comparison: i32,
        exception_out: *mut i32,
    ) -> i32;
    fn rust_mcil_bindgen_system_string_split_string_options(
        string_handle: i32,
        separator_handle: i32,
        options: i32,
        exception_out: *mut i32,
    ) -> i32;
    fn rust_mcil_bindgen_system_string_substring_i32_i32(
        string_handle: i32,
        start_index: i32,
        length: i32,
        exception_out: *mut i32,
    ) -> i32;
    fn rust_mcil_bindgen_system_string_replace_string_string(
        string_handle: i32,
        old_value_handle: i32,
        new_value_handle: i32,
        exception_out: *mut i32,
    ) -> i32;
    fn rust_mcil_bindgen_system_string_array_len(array_handle: i32, exception_out: *mut i32) -> i32;
    fn rust_mcil_bindgen_system_string_array_get(array_handle: i32, index: i32, exception_out: *mut i32) -> i32;
    fn rust_mcil_bindgen_system_string_array_from_strings(
        first_handle: i32,
        second_handle: i32,
        third_handle: i32,
        exception_out: *mut i32,
    ) -> i32;
    fn rust_mcil_bindgen_system_int_array_from_i32_triplet(
        first: i32,
        second: i32,
        third: i32,
        exception_out: *mut i32,
    ) -> i32;
    fn rust_mcil_bindgen_system_int_array_len(array_handle: i32, exception_out: *mut i32) -> i32;
    fn rust_mcil_bindgen_system_int_array_get(array_handle: i32, index: i32, exception_out: *mut i32) -> i32;
    fn rust_mcil_bindgen_system_int_array_copy(
        array_handle: i32,
        destination_ptr: *mut i32,
        destination_capacity: i64,
        exception_out: *mut i32,
    ) -> i32;
    fn rust_mcil_bindgen_system_byte_array_from_u8_triplet(
        first: i32,
        second: i32,
        third: i32,
        exception_out: *mut i32,
    ) -> i32;
    fn rust_mcil_bindgen_system_byte_array_len(array_handle: i32, exception_out: *mut i32) -> i32;
    fn rust_mcil_bindgen_system_byte_array_get(array_handle: i32, index: i32, exception_out: *mut i32) -> i32;
    fn rust_mcil_bindgen_system_byte_array_copy(
        array_handle: i32,
        destination_ptr: *mut u8,
        destination_capacity: i64,
        exception_out: *mut i32,
    ) -> i32;
    fn rust_mcil_bindgen_system_time_span_from_milliseconds_f64(value: f64, exception_out: *mut i32) -> i32;
    fn rust_mcil_bindgen_system_time_span_ticks(time_span_handle: i32, exception_out: *mut i32) -> i64;
    fn rust_mcil_bindgen_system_time_span_total_milliseconds(time_span_handle: i32, exception_out: *mut i32) -> f64;
    fn rust_mcil_bindgen_system_time_span_to_string(time_span_handle: i32, exception_out: *mut i32) -> i32;
    fn rust_mcil_bindgen_system_date_time_offset_from_unix_time_milliseconds_i64(
        milliseconds: i64,
        exception_out: *mut i32,
    ) -> i32;
    fn rust_mcil_bindgen_system_date_time_offset_to_unix_time_milliseconds(
        date_time_offset_handle: i32,
        exception_out: *mut i32,
    ) -> i64;
    fn rust_mcil_bindgen_system_date_time_offset_to_string(date_time_offset_handle: i32, exception_out: *mut i32) -> i32;
    fn rust_mcil_bindgen_system_guid_parse_string(value_handle: i32, exception_out: *mut i32) -> i32;
    fn rust_mcil_bindgen_system_guid_to_string(guid_handle: i32, exception_out: *mut i32) -> i32;
    fn rust_mcil_bindgen_system_callback_apply_i32(
        i32_callback_ptr: fn(i32) -> i32,
        value: i32,
        exception_out: *mut i32,
    ) -> i32;
    fn rust_mcil_bindgen_system_callback_apply_i32_i32(
        i32_i32_callback_ptr: fn(i32, i32) -> i32,
        left: i32,
        right: i32,
        exception_out: *mut i32,
    ) -> i32;
    fn rust_mcil_bindgen_system_callback_transform_managed_string(
        string_transform_callback_ptr: fn(i32) -> i32,
        string_handle: i32,
        exception_out: *mut i32,
    ) -> i32;
    fn rust_mcil_bindgen_system_object_release(object_handle: i32) -> i32;
    fn rust_mcil_bindgen_system_exception_release(exception_handle: i32) -> i32;
    fn rust_mcil_bindgen_system_exception_get_type_name_utf8_len(exception_handle: i32, exception_out: *mut i32) -> i32;
    ...
    fn rust_mcil_bindgen_system_exception_get_message_utf8_len(exception_handle: i32, exception_out: *mut i32) -> i32;
...
pub mod callback {
    ...
    pub fn apply_i32(callback: fn(i32) -> i32, value: i32) -> Result<i32, Exception> {
        let mut exception_handle = 0;
        let result = unsafe {
            super::rust_mcil_bindgen_system_callback_apply_i32(
                callback,
                value,
                &mut exception_handle,
            )
    ...
    pub fn apply_i32_i32(callback: fn(i32, i32) -> i32, left: i32, right: i32) -> Result<i32, Exception> {
        let mut exception_handle = 0;
        let result = unsafe {
            super::rust_mcil_bindgen_system_callback_apply_i32_i32(
                callback,
                left,
                right,
                &mut exception_handle,
    ...
    pub fn transform_managed_string(callback: fn(i32) -> i32, value: &ManagedString) -> Result<ManagedString, Exception> {
        ...
        let object_handle = unsafe {
            super::rust_mcil_bindgen_system_callback_transform_managed_string(
                callback,
                value.handle(),
                &mut exception_handle,
            )
...
pub mod console {
    ...
    pub fn write_line(value: &ManagedString) -> Result<(), Exception> {
        let exception_handle = unsafe {
            super::rust_mcil_bindgen_system_console_write_line_string(
                value.handle(),
            )
        };
        Exception::from_handle(exception_handle)?;
...
pub mod math {
    ...
    pub fn abs(value: f64) -> Result<f64, Exception> {
        let mut exception_handle = 0;
        let value = unsafe {
            super::rust_mcil_bindgen_system_math_abs_f64(
                value,
                &mut exception_handle,
            )
        };
    ...
    pub fn sqrt(value: f64) -> Result<f64, Exception> {
        let mut exception_handle = 0;
        let value = unsafe {
            super::rust_mcil_bindgen_system_math_sqrt_f64(
                value,
                &mut exception_handle,
            )
        };
...
pub mod mathf {
    ...
    pub fn abs(value: f32) -> Result<f32, Exception> {
        let mut exception_handle = 0;
        let value = unsafe {
            super::rust_mcil_bindgen_system_mathf_abs_f32(
                value,
                &mut exception_handle,
            )
        };
    ...
    pub fn cos(value: f32) -> Result<f32, Exception> {
        let mut exception_handle = 0;
        let value = unsafe {
            super::rust_mcil_bindgen_system_mathf_cos_f32(
                value,
                &mut exception_handle,
            )
        };
    ...
    pub fn max(x: f32, y: f32) -> Result<f32, Exception> {
        let mut exception_handle = 0;
        let value = unsafe {
            super::rust_mcil_bindgen_system_mathf_max_f32_f32(
                x,
                y,
                &mut exception_handle,
            )
    ...
    pub fn min(x: f32, y: f32) -> Result<f32, Exception> {
        let mut exception_handle = 0;
        let value = unsafe {
            super::rust_mcil_bindgen_system_mathf_min_f32_f32(
                x,
                y,
                &mut exception_handle,
            )
    ...
    pub fn sin(value: f32) -> Result<f32, Exception> {
        let mut exception_handle = 0;
        let value = unsafe {
            super::rust_mcil_bindgen_system_mathf_sin_f32(
                value,
                &mut exception_handle,
            )
        };
...
pub mod time_span {
    ...
    pub fn from_milliseconds(value: f64) -> Result<ManagedTimeSpan, Exception> {
        let mut exception_handle = 0;
        let object_handle = unsafe {
            super::rust_mcil_bindgen_system_time_span_from_milliseconds_f64(
                value,
                &mut exception_handle,
            )
        };
...
pub mod date_time_offset {
    ...
    pub fn from_unix_time_milliseconds(milliseconds: i64) -> Result<ManagedDateTimeOffset, Exception> {
        let mut exception_handle = 0;
        let object_handle = unsafe {
            super::rust_mcil_bindgen_system_date_time_offset_from_unix_time_milliseconds_i64(
                milliseconds,
                &mut exception_handle,
            )
        };
...
pub mod guid {
    ...
    pub fn parse(value: &ManagedString) -> Result<ManagedGuid, Exception> {
        let mut exception_handle = 0;
        let object_handle = unsafe {
            super::rust_mcil_bindgen_system_guid_parse_string(
                value.handle(),
                &mut exception_handle,
            )
        };
...
pub mod io {
    pub mod directory {
        ...
        pub fn get_files(path: &ManagedString, search_pattern: &ManagedString) -> Result<ManagedStringArray, Exception> {
            let mut exception_handle = 0;
            let object_handle = unsafe {
                super::super::rust_mcil_bindgen_system_io_directory_get_files_string_string(
                    path.handle(),
