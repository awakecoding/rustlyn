...
- `samples/powershell_cmdlets/`: Rust-owned PowerShell format cmdlet runtime for JSON/YAML/TOML/XML/BSON/CBOR/CSV
...
- `dotnet/backend/src/Rustlyn.PowerShellCmdlets/`: generated `PSCmdlet` host shims for Rust-owned format cmdlets
